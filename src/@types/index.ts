...
import { Client, ContextMenuCommandType, EmbedBuilder as MessageEmbed, PermissionsString } from "discord.js";
import Event from "../lib/ClientEvent";
...
export type AnyBuilder = HorizonSlashCommandBuilder | ContextMenuCommandBuilder;
...
export interface CommandOptions {
    /**
     * The command builder similar to @discordjs/builders.
     */
